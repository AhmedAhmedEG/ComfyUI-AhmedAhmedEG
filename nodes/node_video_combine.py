...
class MiniMaxH3VideoCombine:
    ...
    def combine_video(
            ...
            try:
                ...
                if waveform is not None:
                    ...
                    try:
                        ...
                        torchaudio.save(audio_tmp.name, waveform.cpu(), sample_rate)
                    except Exception:
                        import scipy.io.wavfile as wavfile
                        arr = (waveform.squeeze().cpu().numpy() * 32767).astype(np.int16)
        ...
        try:
            ...
            img_bytes = (images.cpu().numpy() * 255).clip(0, 255).astype(np.uint8).tobytes()
